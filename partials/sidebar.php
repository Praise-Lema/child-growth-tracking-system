        ...
        <div class="container py-3 pt-5 d-flex flex-column justify-content-center align-items-center gap-4">
            ...
            <div class="sidebar_items my-4">
                <ul class="list-group text-white">
                    ...
                    <a href="<?php echo ROOT?>child_parameters.php" class="list-group-item bg-transparent border-0 text-white fs-6 sidebar_item <?php echo $_SERVER['REQUEST_URI'] == '/LMS/addbook.php' ? 'fw-bold': '' ?>"><span class="fa fa-square-plus me-3"></span>Measurement Entries</a>
